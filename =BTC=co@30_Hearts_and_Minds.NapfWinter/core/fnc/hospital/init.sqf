...
_action = ["Heal", localize "STR_BTC_HAM_ACTION_HOSPITAL_HEAL", "\A3\ui_f\data\igui\cfg\simpleTasks\types\heal_ca.paa", {[_target, 5] call btc_hospital_fnc_heal}, {true}] call ace_interact_menu_fnc_createAction;
