class Params {
    ...
    class btc_p_rep { // Reputation at start:
        ...
        texts[]={"I Hate you", $STR_ACE_ViewDistance_object_verylow,$STR_A3_TIME_TRIALS_MISCTT_ROF_25,$STR_3DEN_ATTRIBUTES_SPEEDMODE_NORMAL,$STR_A3_TIME_TRIALS_MISCTT_ROF_21}; //texts[]={"Very Low","Low","Normal","High"};
        default = -200;
    };
    ...
    class btc_p_trigger { // Disable city activation when a plane or helicopter (>300Km/h) is flying above:
